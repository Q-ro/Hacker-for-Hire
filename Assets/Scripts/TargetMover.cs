...
public class TargetMover : MonoBehaviour {
    ...
    public enum motionDirections { Spin, HorizontalX, HorizontalZ, Vertical };
	
	// store the state
	public motionDirections motionState = motionDirections.HorizontalX;
